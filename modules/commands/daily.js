module.exports.config = {
	...
	hasPermssion: 0,
	credits: "Miraiv2",
	description: "Nhận 5000 đô 20 phút!.",
...
module.exports.run = async ({ event, api, Currencies }) => {
    ...
    else return api.sendMessage(`Bạn đã nhận ${rewardCoin} đô, để có thể tiếp tục nhận, vui lòng quay lại sau 20 phút.`, threadID, async () => {
